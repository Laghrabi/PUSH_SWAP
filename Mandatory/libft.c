...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/31 11:17:37 by claghrab          #+#    #+#             */
/*   Updated: 2025/01/31 12:29:03 by claghrab         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * Allocates memory for the substring and returns it. Handles cases where
	...
	* the start index is beyond the string length or 
	the length exceeds available characters.
 *
